...
public class BaseRequest 
{
	...
	public void SendRequest(Object[] objectArrayHeader, Object objectBody, String paramValue) throws Exception 
	{
		try 
		{
			...
			LogHandler.info("HTTP Response: [" + RequestSpecificationManager.GetResponse().body().asString() + "]");
			LogHandler.info("SendRequest() passed");
		}
		catch(Exception e) 
		{
			LogHandler.error("SendRequest() failed");
